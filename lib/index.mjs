...
class Window {
    ...
    setKeyCallback(cb) {
        ...
        this.keyCallback = cb;
        this.internalKeyCallback = new JSCallback(
        ...
        lib.symbols.set_keyboard_callback(
            this.instance,
            this.internalKeyCallback,
        );
    }
    ...
    setTextCallback(cb) {
        ...
        this.internalTextCallback = new JSCallback(
            (instance, cp) => {
    ...
    setSizeCallback(cb) {
        ...
        this.internalSizeCallback = new JSCallback(
            (instance, w, h) => {
                cb(w, h);
                return true;
            },
        ...
        lib.symbols.set_frambuffer_callback(
            this.instance,
    ...
    setMouseButtonCallback(cb) {
        ...
        this.internalMouseButtonCallback = new JSCallback(
    ...
    setFocusCallback(cb) {
        ...
        this.internalWindowFocusCallback = new JSCallback(
            (instance, f) => {
                cb(f === 1 ? true : false);
                return true;
            },
